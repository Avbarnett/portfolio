function calculate() {
    ...
    if ($( "#myform" ).valid()) {
        ...
        /* if the operator was "Add" then add operand1 and operand2 */
        if (operator == "Add") {
            result = (operand1fp + operand2fp)
        }
 
        /* if the operator was "Subtract" then subtract operand1 from operand2 */
        if (operator == "Subtract") {
            result = (operand1fp - operand2fp) ;
        }

        /* if operator was "Multiply" then multiply operand1 and operand2 */
        ...
        /* if operator was "Divide" then divide operand1 by operand2 */
        if (operator == "Divide") {
            result = (operand1fp / operand2fp) ;
        }
